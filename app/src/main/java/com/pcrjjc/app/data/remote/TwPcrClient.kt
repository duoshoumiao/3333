...
/**
 * Taiwan server PCR client corresponding to pcrjjc2/client/tw_pcrclient.py
 */
class TwPcrClient(
    ...
    /**
     * Encode SHORT-UDID (corresponds to _encode() in tw_pcrclient.py)
     */
    private fun encode(dat: String): String {
        ...
        // Append random iv string (32 chars)
    ...
    suspend fun callApi(apiUrl: String, request: MutableMap<String, Any?>, noerr: Boolean = false): Map<String, Any?> {
        ...
        try {
            ...
            // SHA1 signature for PARAM header
